...
public partial class MainWindow : Window
{
    ...
    private AgentAdvertiser? _advertiser;
    ...
    public MainWindow()
    {
        ...
        try
        {
            ...
            _overlayManager = new OverlayManager(_displayManager, Dispatcher);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            await Task.Run(() =>
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    _advertiser?.UpdateOutputCount(_outputs.Count);
                });
            });
        }
        catch (Exception ex)
    ...
    private async Task StartServerAsync()
    {
        try
        {
            ...
            var grpcService = new AgentGrpcService(_machineId, _displayDetector, _displayManager, _overlayManager, _syncClock);
            ...
            _advertiser = new AgentAdvertiser(_machineId, Environment.MachineName, port, _outputs.Count);
            _advertiser.Start();
        }
        catch (Exception ex)
        {
